...
The section [Add Component Version to CTF archive]({{< relref "docs/getting-started/create-component-version.md#add-component-version-to-ctf-archive/" >}}) explained how to store component versions in a CTF archive.
