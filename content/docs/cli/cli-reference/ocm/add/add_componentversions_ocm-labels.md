...
title: ocm-labels
name: add ocm-labels
url: /docs/cli/cli-reference/ocm/add/ocm-labels/
...
* [ocm add componentversions](/docs/cli/cli-reference/ocm/add/componentversions)	 &mdash; add component version(s) to a (new) transport archive
