...
url: /docs/cli/cli-reference/ocm/add/resource-configuration/
...
Add a resource specification to a resource config file used by [ocm add resources](/docs/cli/cli-reference/ocm/add/resources).
...
- Access type <code>helm</code>
  ...
  - Version <code>v1</code>
    ...
    for a hostpath identity matcher (see [ocm get credentials](/docs/cli/cli-reference/ocm/get/credentials)).
