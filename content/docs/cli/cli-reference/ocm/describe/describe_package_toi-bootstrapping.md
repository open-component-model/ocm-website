...
name: describe toi-bootstrapping
url: /docs/cli/cli-reference/ocm/describe/toi-bootstrapping/
...
(see [ocm bootstrap package](/docs/cli/cli-reference/ocm/bootstrap/package)).
...
When calling the [ocm bootstrap package](/docs/cli/cli-reference/ocm/bootstrap/package) command it is selected by a resource
...
- **<code>additionalResources</code>** (optional) *map[string]AdditionalResource)*
  ...
  Those templates can be downloaded with [ocm bootstrap config](/docs/cli/cli-reference/ocm/bootstrap/config).
...
Credentials are provided in an ocm config file (see [ocm configfile](/docs/cli/cli-reference/ocm/configfile)).
...
* [ocm describe package](/docs/cli/cli-reference/ocm/describe/package)	 &mdash; describe TOI package
