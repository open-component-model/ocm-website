...
title: attributes
name: ocm attributes
url: /docs/cli/cli-reference/ocm/ocm/attributes/
...
attributes using the config file (see [ocm configfile](/docs/cli/cli-reference/ocm/configfile)) or by
command line options of the main command (see [ocm](/docs/cli/cli-reference/ocm)).
