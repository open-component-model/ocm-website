...
url: /docs/cli/cli-reference/ocm/ocm/ocm-uploadhandlers/
...
[ocm transfer componentversions](/docs/cli/cli-reference/ocm/transfer/componentversions) or [ocm transfer commontransportarchive](/docs/cli/cli-reference/ocm/transfer/commontransportarchive).
...
See [ocm ocm-uploadhandlers](/docs/cli/cli-reference/ocm/ocm-uploadhandlers) for further details on using
upload handlers.
