...
name: ocm ocm-downloadhandlers
url: /docs/cli/cli-reference/ocm/ocm/ocm-downloadhandlers/
...
(see [ocm ocm-accessmethods](/docs/cli/cli-reference/ocm/ocm-accessmethods)) are used to store the resource content
...
[ocm download resources](/docs/cli/cli-reference/ocm/download/resources) (implicitly registered download handlers
...
See [ocm ocm-downloadhandlers](/docs/cli/cli-reference/ocm/ocm-downloadhandlers) for further details on using
download handlers.
