...
url: /docs/cli/cli-reference/ocm/add/source-configuration/
...
Add a source specification to a source config file used by [ocm add sources](/docs/cli/cli-reference/ocm/add/sources).
