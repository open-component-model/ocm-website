...
url: /docs/cli/cli-reference/ocm/add/componentversions/
...
[ocm add sources](/docs/cli/cli-reference/ocm/add/sources), [ocm add resources](/docs/cli/cli-reference/ocm/add/resources), [ocm add references](/docs/cli/cli-reference/ocm/add/references),
respectively.
...
(see [ocm ocm-labels](/docs/cli/cli-reference/ocm/ocm-labels)).
...
* [ocm add](/docs/cli/cli-reference/ocm/add)	 &mdash; Add elements to a component repository or component version



##### Additional Help Topics

* [ocm add componentversions <b>ocm-labels</b>](/docs/cli/cli-reference/ocm/add/componentversions/ocm-labels)	 &mdash; Labels and Label Merging
