...
title: configfile
name: ocm configfile
url: /docs/cli/cli-reference/ocm/ocm/configfile/
...
- <code>downloader.ocm.config.ocm.software</code>
  ...
  of pre-configured download handler registrations (see [ocm ocm-downloadhandlers](/docs/cli/cli-reference/ocm/ocm-downloadhandlers)):
