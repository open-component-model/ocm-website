...
Air-gapped can mean different things depending on the context. For the purposes of this guide we'll assume it means your deployment artifacts are stored in a private registry that is protected by the security controls put in place at your organization. Your applications only have access to this private registry and have little to no public internet access.
