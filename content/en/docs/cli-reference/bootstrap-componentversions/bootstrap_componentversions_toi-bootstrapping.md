...
menu:
  docs:
    parent: bootstrap_componentversions
toc: true
isCommand: true
---
### Description
...
(see [ocm bootstrap componentversions](/docs/cli/bootstrap/componentversions)).
...
* [ocm bootstrap componentversions](/docs/cli/bootstrap/componentversions)	 &mdash; bootstrap component version
