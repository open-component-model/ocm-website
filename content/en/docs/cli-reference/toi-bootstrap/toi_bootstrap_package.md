---
title: package
name: toi_bootstrap package
url: /docs/cli/toi_bootstrap/package/
date: 2024-04-03T14:21:11+02:00
draft: false
images: []
menu:
  docs:
    parent: toi_bootstrap
toc: true
isCommand: true
---
### Usage
...
```
ocm toi bootstrap package [<options>] <action> {<component-reference>} {<resource id field>}
```
...
* [ocm toi bootstrap](/docs/cli/toi/bootstrap)	 &mdash; bootstrap components
...
* [ocm toi bootstrap package <b>toi-bootstrapping</b>](/docs/cli/toi/bootstrap/package/toi-bootstrapping)	 &mdash; Tiny OCM Installer based on component versions
