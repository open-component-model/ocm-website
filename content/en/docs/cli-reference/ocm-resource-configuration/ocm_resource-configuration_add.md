---
title: add
name: ocm_resource-configuration add
url: /docs/cli/ocm_resource-configuration/add/
date: 2024-04-03T14:21:11+02:00
draft: false
images: []
menu:
  docs:
    parent: ocm_resource-configuration
toc: true
isCommand: true
---
### Usage
...
```
ocm ocm resource-configuration add [<options>] <target> {<configfile> | <var>=<value>}
```
...
* [ocm ocm resource-configuration](/docs/cli/cli/resource-configuration)	 &mdash; Commands acting on component resource specifications
