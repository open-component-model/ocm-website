---
title: add
name: ocm_sources add
url: /docs/cli/ocm_sources/add/
...
```
ocm ocm sources add [<options>] [<target>] {<resourcefile> | <var>=<value>}
```
...
* [ocm ocm sources](/docs/cli/cli/sources)	 &mdash; Commands acting on component sources
