---
title: add
name: ocm_source-configuration add
url: /docs/cli/ocm_source-configuration/add/
date: 2024-04-03T14:21:11+02:00
draft: false
images: []
menu:
  docs:
    parent: ocm_source-configuration
toc: true
isCommand: true
---
### Usage
...
```
ocm ocm source-configuration add [<options>] <target> {<configfile> | <var>=<value>}
```
...
* [ocm ocm source-configuration](/docs/cli/cli/source-configuration)	 &mdash; Commands acting on component source specifications
