---
title: add
name: ocm_references add
url: /docs/cli/ocm_references/add/
date: 2024-04-03T14:21:11+02:00
draft: false
images: []
menu:
  docs:
    parent: ocm_references
toc: true
isCommand: true
---
### Usage
...
```
ocm ocm references add [<options>] [<target>] {<referencefile> | <var>=<value>}
```
...
* [ocm ocm references](/docs/cli/cli/references)	 &mdash; Commands related to component references in component versions
