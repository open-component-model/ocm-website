---
title: bootstrap
name: toi_package bootstrap
url: /docs/cli/toi_package/bootstrap/
...
```
ocm toi package bootstrap [<options>] <action> {<component-reference>} {<resource id field>}
```
...
* [ocm toi package](/docs/cli/toi/package)	 &mdash; TOI Commands acting on components
...
* [ocm toi package bootstrap <b>toi-bootstrapping</b>](/docs/cli/toi/package/bootstrap/toi-bootstrapping)	 &mdash; Tiny OCM Installer based on component versions
