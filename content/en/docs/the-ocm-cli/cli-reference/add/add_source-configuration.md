...
url: /docs/the-ocm-cli/cli-reference/add/source-configuration/
...
Add a source specification to a source config file used by [ocm add sources](/docs/the-ocm-cli/cli-reference/add/sources).
