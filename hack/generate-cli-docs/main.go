...
func main() {
	...
	flag.StringVar(&outputDir, "output-dir", "./content/en/docs/the-ocm-cli/cli-reference", "output directory for generated docs")
	flag.StringVar(&urlPrefix, "url-prefix", "/docs/the-ocm-cli/cli-reference/", "prefix for cli docs urls")
